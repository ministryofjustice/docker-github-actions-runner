...
npm install --unsafe-perm -g grunt gulp n parcel-bundler typescript newman
npm install --unsafe-perm -g --save-dev webpack webpack-cli
npm install --unsafe-perm -g npm
rm -rf ~/n
